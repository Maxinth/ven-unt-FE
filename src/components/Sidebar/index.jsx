...
const Sidebar = ({ isMobileSideBarOpen }) => {
  ...
  return (
    <div
      className={`absolute -top-6 min-w-[270px] max-w-[279px] left-0 p-2 px-[24px] border border-red-500 w-2/3 ease-in duration-300 z-50 bg-white md:translate-x-[0px] md:relative md:w-[279px] md:top-0 ${
